...
import com.zjz.youwenbida.common.*;
...
import com.zjz.youwenbida.model.dto.app.AppAddRequest;
import com.zjz.youwenbida.model.dto.app.AppEditRequest;
import com.zjz.youwenbida.model.dto.app.AppQueryRequest;
import com.zjz.youwenbida.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    private BaseResponse<Page<AppVO>> getAppVOPageResponse(AppQueryRequest appQueryRequest,
                                                           HttpServletRequest request) {
        long current = appQueryRequest.getCurrent();
        long size = appQueryRequest.getPageSize();
        // 限制爬虫
    ...
    public BaseResponse<Boolean> editApp(@RequestBody AppEditRequest appEditRequest, HttpServletRequest request) {
        if (appEditRequest == null || appEditRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "请求错误或AppId不存在");
        }
        App app = new App();
